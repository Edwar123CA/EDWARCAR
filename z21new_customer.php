                    ...
                    <div class="col-sm-12 col-xl-35">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="d-flex justify-content-end align-items-center">
                                <a href="z20list_customer.php" class="btn btn-warning"><i class="bi bi-list-ol"></i> List Customers</a>
                            </div>
                            <div class="m-n2">
                                <div class="container position-relative">
                                    <h2 class="my-4">Customer form</h2>
                                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                                <i class="fa fa-exclamation-circle me-2"></i>Dear user, remember to fill out the entire form!
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            </div>
                                    <form id="orderForm" action="z22procesar_customer.php" method="POST" class="text-white">
                                        ...
                                        <button type="submit" class="btn btn-info" id="submitBtn">Add Client:</button>
                                    </form>
                                </div>
                            </div>
                        </div>
