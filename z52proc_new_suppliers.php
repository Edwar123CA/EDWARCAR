...
<?php
                                    ...
                                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                        ...
                                        $query = "INSERT INTO suppliers (contact_name, contact_title, address, city, region, postal_code, country, phone, fax, home_page) 
                                        VALUES ('$contact_name', '$contact_title', '$address', '$city', '$region', '$postal_code', '$country', '$phone', '$fax', '$home_page')";

                                        if (mysqli_query($conn, $query)) {
                                            // La orden se ha guardado exitosamente
                                            header("Location: z50list_supplier.php?edit=successo");
                                        } else {
