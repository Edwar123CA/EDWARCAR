                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-35">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4 text-primary">Category General</h6>
                            <div class="d-flex justify-content-end align-items-center">
                                <a href="z30list_category.php" class="btn btn-light"><i class="bi bi-list-ol"></i> List Category</a>
                            </div>
                            <div class="m-n2">
                                <div class="container">
                                            ...
                                            <h1>Edit Category</h1>
                                                ...
                                                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["category_id"])) {
                                                    ...
                                                    if (mysqli_num_rows($result) == 1) {
                                                        ...
                                                        <form method="post" action="z35proc_edit_category.php" class="text-primary" enctype="multipart/form-data">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                if (!empty($row['picture'])) {
                                                                    echo "<img src='img/img2/" . $row['picture'] . "' alt='Current Category Image' style='max-width: 100px;'>";
                                                                } else {
                                                                    echo "No picture available.";
                                                                }
                                                                ?>
                                                                <br>
                                                                <label for="new_picture" class="form-label">New Picture:</label>
                                                        ...
                                                        <a href="z30list_category.php" class="btn btn-warning">Cancel</a>
                                                        <?php
                                                    } else {
