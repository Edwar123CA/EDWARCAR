                                    ...
                                    <script>
                                        $(window).on('load', function(){
                                            ...
                                            setTimeout(function(){
                                                ...
                                                window.location.href = 'z30list_category.php';
                                    ...
                                    <script>
                                        $(window).on('load', function(){
                                            ...
                                            setTimeout(function(){
                                                ...
                                                // Recarga la página con la URL original
                                                window.location.href = 'z60list_shipper.php';
                                            }, 3000); // 3000 milisegundos = 3 segundos
                                        });
                                    </script>";
                            }
 ...
 <!-- -------------------------------------------------------------------------------------------------->
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-35">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Shippers General</h6>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="z61new_shipper.php" class="btn btn-success"><i class="bi bi-plus"></i> New Shipper</a>
                            </div>
                            <div class="table-responsive">
                                ...
                                <thead>
                                    ...
                                    $query = "SELECT * FROM shippers WHERE state = 'activo'";
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            // Mostrar la imagen
                                            //echo "<td><img src='img/img2/" . $row['picture'] . "' alt='Category Image' style='max-width: 100px;'></td>";
                                        ...
                                        // Agregar botones Editar y Eliminar en la misma celda de "Acciones"
                                            ...
                                            //echo "<form method='post' action='z34editar_category.php'>"; // Cambié el action a 'editar_orden.php'
                                            ...
                                            echo "<form method='post' action='z53eliminar_supp.php'>";
                                            echo "<input type='hidden' name='shipper_id' value='" . $row['shipper_id'] . "'>";
                                            echo "<button type='button' class='btn btn-primary confirm-delete' data-orderid='" . $row['shipper_id'] . "'>";
    ...
    <script>
        ...
        $("#confirmDeleteButton").on("click", function () {
            ...
            $.ajax({
                type: "POST",
                url: "z53eliminar_supp.php",
                data: { supplier_id: orderId },
