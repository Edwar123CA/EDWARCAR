                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-35">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Products General</h6>
                            <div class="d-flex justify-content-end align-items-center">
                                <a href="z40list_product.php" class="btn btn-warning"><i class="bi bi-list-ol"></i> List Products</a>
                            </div>
                            <div class="m-n2">
                                ...
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    ...
                                    <form id="orderForm" action="z42proc_product.php" method="POST" class="text-white" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-4">
                                                <label for="supplier_id" class="form-label">Suppliere:</label>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                <label for="quantity_per_unit" class="form-label">Quantity:</label>
                                                <input type="text" class="form-control" name="quantity_per_unit" id="quantity_per_unit">
                                            </div>
                                            <div class="col-md-4">
                                                <label for="unit_price" class="form-label">Price U.:</label>
                                                <input type="text" class="form-control" name="unit_price" id="unit_price">
                                            </div>
                                            <div class="col-md-4">
                                                <label for="units_in_stock" class="form-label">Stock:</label>
                                                <input type="text" class="form-control" name="units_in_stock" id="units_in_stock">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                <label for="units_on_order" class="form-label">Unit Order:</label>
                                                <input type="text" class="form-control" name="units_on_order" id="units_on_order">
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-4">
                                                <label for="discontinued" class="form-label">Descontinued:</label>
                                                <input type="text" class="form-control" name="discontinued" id="discontinued">
                                            </div>
                                        </div>
                                        
                                        <button type="submit" class="btn btn-info" id="submitBtn">Add Product:</button>
                                    </form>
                                </div>
                            </div>
                        </div>
