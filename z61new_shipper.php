                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-35">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Shipper General</h6>
                            <div class="d-flex justify-content-end align-items-center">
                                <a href="z60list_shipper.php" class="btn btn-warning"><i class="bi bi-list-ol"></i> List Shippers</a>
                            </div>
                            <div class="m-n2">
                                <div class="container position-relative">
                                    <h2 class="my-4">Form of Shipper</h2>
                                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                                <i class="fa fa-exclamation-circle me-2"></i>Dear user, remember to fill out the entire form!
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            </div>
                                    <form id="orderForm" action="z62proc_shipper.php" method="POST" class="text-white" enctype="multipart/form-data">
                                        ...
                                        <button type="submit" class="btn btn-info" id="submitBtn">Add Shipper:</button>
                                    </form>
                                </div>
                            </div>
                        </div>
