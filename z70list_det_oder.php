...
<?php
                                    ...
                                    <script>
                                        $(window).on('load', function(){
                                            ...
                                            setTimeout(function(){
                                                ...
                                                window.location.href = 'z13list_order.php';
    ...
    <?php
                            // Verifica si el parámetro 'create' está presente y tiene el valor 'success'
                                    ...
                                    <script>
                                        $(window).on('load', function(){
                                            ...
                                            setTimeout(function(){
                                                ...
                                                // Recarga la página con la URL original
                                                window.location.href = 'z70list_det_order.php';
                                            }, 3000); // 3000 milisegundos = 3 segundos
                                        });
                                    </script>";
                            }
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <form class="d-none d-md-flex ms-4">
                    <input class="form-control bg-dark border-0" type="search" placeholder="Search by Ship Name">
                </form>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title text-dark" id="confirmDeleteModalLabel">Deletion Confirmation</h5>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-danger" id="confirmDeleteButton">Eliminate</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container-fluid pt-0 px-0">
                <div class="bg-secondary text-center rounded p-0">
                    <div class="d-flex align-items-center justify-content-between mb-0">
                        <!--<h6 class="mb-0">Recent Salse</h6>
                        <a href="">Show All</a>-->
                        <div class="d-flex justify-content-between align-items-center">
                                <a href="z71newdet_order.php" class="btn btn-warning"><i class="bi bi-plus"></i> New Detail</a>
                            </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0 table-dark">
                            <thead>
                                <tr>
                                    <th> ID</th>
                                    <!--<th>User ID</th>
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT * FROM order_details WHERE state = 'Activo'";
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        // Agregar botones Editar y Eliminar en la misma celda de "Acciones"
                                            ...
                                            echo "<form method='post' action='z14editar_orden.php'>"; // Cambié el action a 'editar_orden.php'
                                            echo "<input type='hidden' name='order_details_id' value='" . $row['order_details_id'] . "'>";
                                            echo "<button type='submit' class='btn btn-info'>";
                                            echo "<i class='bi bi-pencil-square'></i> Editar";
                                            echo "</button>";
                                            echo "</form>";

                                            echo "<form method='post' action='z16eliminar_orden.php'>";
                                            echo "<input type='hidden' name='order_details_id' value='" . $row['order_details_id'] . "'>";
                                            echo "<button type='button' class='btn btn-primary confirm-delete' data-orderid='" . $row['order_details_id'] . "'>";
