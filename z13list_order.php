                ...
                <div class="bg-secondary text-center rounded p-0">
                    <div class="d-flex align-items-center justify-content-between mb-0">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                                <a href="z11new_orders.php" class="btn btn-warning"><i class="bi bi-plus"></i> New Orden</a>
                            </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        // Agregar botones Editar y Eliminar en la misma celda de "Acciones"
                                            ...
                                            echo "<input type='hidden' name='order_id' value='" . $row['order_id'] . "'>";
                                            echo "<button type='button' class='btn btn-primary confirm-delete' data-orderid='" . $row['order_id'] . "'>";
