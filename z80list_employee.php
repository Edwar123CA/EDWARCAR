                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-35">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Employees General</h6>
                ...
                <div class="bg-secondary text-center rounded p-0">
                    <div class="d-flex align-items-center justify-content-between mb-0">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                                <a href="z71newdet_order.php" class="btn btn-warning"><i class="bi bi-plus"></i> New Employee</a>
                            </div>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0 table-dark">
                            <thead>
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT * FROM employees WHERE state = 'Activo'";
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<td>" . $row['title_of_courtesy'] . "</td>";
                                        ...
                                        // Agregar botones Editar y Eliminar en la misma celda de "Acciones"
                                            ...
                                            echo "<input type='hidden' name='employee_id' value='" . $row['employee_id'] . "'>";
                                            echo "<button type='button' class='btn btn-primary confirm-delete' data-orderid='" . $row['employee_id'] . "'>";
