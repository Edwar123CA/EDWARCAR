 ...
 <!-- -------------------------------------------------------------------------------------------------->
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-35">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Category General</h6>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="z31new_category.php" class="btn btn-success"><i class="bi bi-plus"></i> New Category</a>
                            </div>
                            <div class="table-responsive">
                                ...
                                <thead>
                                    ...
                                    $query = "SELECT * FROM categories WHERE state = 'activo'";
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        // Agregar botones Editar y Eliminar en la misma celda de "Acciones"
                                            ...
                                            echo "<form method='post' action='z33eliminar_category.php'>";
                                            echo "<input type='hidden' name='category_id' value='" . $row['category_id'] . "'>";
                                            echo "<button type='button' class='btn btn-primary confirm-delete' data-orderid='" . $row['category_id'] . "'>";
    ...
    <script>
        ...
        $("#confirmDeleteButton").on("click", function () {
            ...
            $.ajax({
                type: "POST",
                url: "z33eliminar_category.php",
                data: { category_id: orderId },
