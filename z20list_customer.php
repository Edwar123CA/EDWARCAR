                                    ...
                                    <script>
                                        $(window).on('load', function(){
                                            ...
                                            setTimeout(function(){
                                                ...
                                                window.location.href = 'z20list_customer.php';
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-35">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Customers General</h6>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="z21new_customer.php" class="btn btn-success"><i class="bi bi-plus"></i> New Orden</a>
                            </div>
                                ...
                                <thead>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        // Agregar botones Editar y Eliminar en la misma celda de "Acciones"
                                            ...
                                            echo "<form method='post' action='z24editar_customer.php'>"; // Cambié el action a 'editar_orden.php'
                                            ...
                                            echo "<form method='post' action='z23eliminar_cust.php'>";
                                            echo "<input type='hidden' name='customer_id' value='" . $row['customer_id'] . "'>";
