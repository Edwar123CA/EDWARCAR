                                    ...
                                    <script>
                                        $(window).on('load', function(){
                                            ...
                                            setTimeout(function(){
                                                ...
                                                // Recarga la página con la URL original
                                                window.location.href = 'z40list_product.php';
                                            }, 3000); // 3000 milisegundos = 3 segundos
                                        });
                                    </script>";
                            }
                    ...
                    <div class="col-sm-12 col-xl-35">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="z41new_product.php" class="btn btn-success"><i class="bi bi-plus"></i> New Product</a>
                            </div>
                            <div class="table-responsive">
                                ...
                                <thead>
                                    ...
                                    $query = "SELECT * FROM products WHERE state = 'activo'";
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        // Agregar botones Editar y Eliminar en la misma celda de "Acciones"
                                            ...
                                            echo "<input type='hidden' name='product_id' value='" . $row['product_id'] . "'>";
                                            echo "<button type='button' class='btn btn-primary confirm-delete' data-orderid='" . $row['product_id'] . "'>";
