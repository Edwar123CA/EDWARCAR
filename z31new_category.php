                    ...
                    <div class="col-sm-12 col-xl-35">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="d-flex justify-content-end align-items-center">
                                <a href="z30list_category.php" class="btn btn-warning"><i class="bi bi-list-ol"></i> List Category</a>
                            </div>
                            <div class="m-n2">
                                <div class="container position-relative">
                                    <h2 class="my-4">Category Form</h2>
                                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                                        <i class="fa fa-exclamation-circle me-2"></i>Dear user, remember to fill out the entire form!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                                    <form id="orderForm" action="z32procesar_category.php" method="POST" class="text-white" enctype="multipart/form-data">
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                        ...
                                        <button type="submit" class="btn btn-info" id="submitBtn">Add Category</button>
                                    </form>
                                </div>
                            </div>
                        </div>
