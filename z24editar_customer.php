                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-35">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4 text-primary">Customers General</h6>
                            <div class="d-flex justify-content-end align-items-center">
                                <a href="z20list_customer.php" class="btn btn-light"><i class="bi bi-list-ol"></i> List Orders</a>
                            </div>
                            <div class="m-n2">
                                <div class="container">
                                            ...
                                            <h1>Edit Customer</h1>
                                                ...
                                                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["customer_id"])) {
                                                    ...
                                                    if (mysqli_num_rows($result) == 1) {
                                                        ...
                                                        <form method="post" action="z25procs_edi_customer.php" class="text-primary">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="contact_name" id="contact_name" value="<?php echo $row['contact_name']; ?>">
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <label for="region" class="form-label">Region:</label>
                                                                <input type="text" class="form-control" name="region" id="region" value="<?php echo $row['region']; ?>">
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="fax" id="fax" value="<?php echo $row['fax']; ?>">
                                                            </div>
                                                            <input type="hidden" name="state" value="<?php echo $row['state']; ?>">

                                                            <button type="submit" class="btn btn-primary">Save Changes</button>
                                                        </form>
                                                        <a href="z20list_customer.php" class="btn btn-warning">Cancel</a>
                                                        <?php
                                                    } else {
